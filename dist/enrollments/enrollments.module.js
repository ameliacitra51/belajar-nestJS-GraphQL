...
const enrollments_resolver_1 = require("./enrollments.resolver");
...
exports.EnrollmentsModule = EnrollmentsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [enrollments_resolver_1.EnrollmentsResolver, enrollments_service_1.EnrollmentsService],
